...
const NavBar = ({ setTheme, checked }) => {
  ...
  return (
    <nav className="backdrop-blur-2xl  backdrop-brightness-150 dark:backdrop-brightness-50 shadow-sm border-1 px-2 sm:px-4 py-2.5 fixed top-0 left-0 right-0 bottom-auto z-10 text-gray-800 dark:text-gray-300">
